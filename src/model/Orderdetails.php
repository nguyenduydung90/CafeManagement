...
protected $img;
     ...
     * @param $img
     */
    public function __construct($id, $beverageID, $beverageName, $priceEach, $img)
    {
        $this->id = $id;
    ...
    /**
     * @param mixed $beverageID
     */
    public function setBeverageID($beverageID): void
    {
        $this->beverageID = $beverageID;
    }
