            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped" style="text-align: center">
                    ...
                    <tr style="text-align: center;">
                        ...
                        <td style=""><?php echo $item->getBeverageName()?></td>
                        <td><input  type="text" value="0" style="width: 100px" /></td>
                        <td><?php  echo number_format($item->getPriceEach(),0,'.',',') ?> VNĐ</td>
                        <td><a href="index.php?page=orderList&id=<?php echo $item->getId()?>" type="submit" class="btn btn-danger">Chọn</a> </td>
                    </tr>
                    <?php endforeach;?>
                    <?php endif; ?>
                    </form>
